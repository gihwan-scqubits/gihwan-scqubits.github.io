...
Because $$E_L \gg E_J$$, the $$\phi'$$ mode is far too high in energy for anything at the qubit's energy scale to perturb it away from equilibrium. So we can replace it by its equilibrium value and skip the gauge subtleties for this node. (This stops being safe once $$E_J$$ becomes comparable to $$E_L$$, as it can with very large junctions.) Minimizing $$U_L$$,
